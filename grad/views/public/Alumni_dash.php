...
<head>
    ...
    .middle-card {
        ...
        margin-right: 20px;
        /* Space between middle and right sidebar */
    }
    ...
    .card-footer {
        background-color: #f8f9fa;
        /* Match footer background with header */
        border-top: 1px solid #e0e0e0;
        /* Border separating footer */
        padding: 10px 15px;
        /* Padding for spacing */
    }
            ...
            <div class="content-row">
                ...
                <div class="left-sidebar">
                    <div class="link-container">
                        <div class="card">
                            <a href="Alumni_dash.php"><i class="fa-solid fa-house fa-lg"
                                    style="color: #4c8fe7; margin-right:6px;"></i>Home</a>

                            <a href="jobs.php"><i class="fa-solid fa-briefcase fa-lg"
                                    style="color: #4c8fe7; margin-right:6px;"></i>Jobs</a>
                            <a href="events.php"><i class="fa-regular fa-calendar-days fa-lg"
                                    style="color: #4c8fe7; margin-right:6px;"></i> Events</a>
                            <a href="gallery.php"><i class="fa-regular fa-image fa-lg"
                                    style="color: #4c8fe7; margin-right:6px;"></i> Gallery</a>
                            <a href="news.php"><i class="fa-solid fa-file fa-lg"
                                    style="color: #4c8fe7; margin-right:6px;"></i>News</a>
                        </div>
                    </div>
                </div>
                <div class="middle-card">
                    <div class="card">
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#postModal" class="modal-trigger">What is on
                            your mind?</a>
...
if ($result->num_rows > 0) {
    ...
    <script src="https://cdnjs.cloudfare.com/ajax/libs/font-awesome/5.15.4/js/all.min.js"></script>
</body>
